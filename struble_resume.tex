...
An active blog series cataloguing every step I took, from data analysis to model deployment, in development of a novel deep learning model capable of judging photo aesthetics.
...
Tested multiple NLP algorithms like BERT, ensemble, and bag of words, in an attempt to understand -- and visualize -- Americans' views of climate change over time.
